      ...
      <main>
        ...
        <div className="grid">
            <p className="description">
              In this graph you can see the time (in seconds) dedicated to the activities.
            </p>
            {isLoading && <p className="loading">Loading graph...</p>}
            <p className="graph">
                <img className="img" src={`http://127.0.0.1:8000/showGraphHistogram/graph/${id}`} onLoad={()=>cambiarEstado()}/>
            </p>
